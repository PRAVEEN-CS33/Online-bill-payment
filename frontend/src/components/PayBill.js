        ...
        <div className="bill-section">
          <div>
            ...
            <div className="option">
              ...
              <div>
                <img src={dth} className="img-paybill" />
                <h4>DTH / Cable TV</h4>
              </div>
              <div>
                <img src={gplay} className="img-paybill" />
                <h4>Google Play</h4>
              </div>
              <div>
                <img src={toll} alt="toll" className="img-paybill" />
                <h4>FASTag Recharge</h4>
              </div>
            </div>
          </div>
          <div>
            <h2 className="tle-h">Utility bills</h2>
            <div className="option">
              <div>
                <img src={elec} alt="electricity" className="img-paybill" />
                <h4>Electricity</h4>
              </div>
              <div>
                <img src={broad} alt="broadband" className="img-paybill" />
                <h4>Broadband / Landline</h4>
              </div>
              <div>
                <img src={postm} alt="postpaid" className="img-paybill" />
                <h4>Postpaid mobile</h4>
              </div>
              <div>
                <img src={water} alt="water" className="img-paybill" />
                <h4>Water</h4>
              </div>
              <div>
                <img src={gas} alt="gas" className="img-paybill" />
                <h4>Gas</h4>
              </div>
              <div>
                <img src={edu} alt="education" className="img-paybill" />
                <h4>Education</h4>
              </div>
            </div>
          </div>
